...
// CSearchDogInfoDlg 메시지 처리기

BOOL CSearchDogInfoDlg::OnInitDialog()
{
...
void CSearchDogInfoDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CSearchDogInfoDlg::OnPaint()
{
	if (IsIconic())
	{
...
//  이 함수를 호출합니다.
HCURSOR CSearchDogInfoDlg::OnQueryDragIcon()
{
